...
(function () {
  ...
  const icons = {
    ...
    ai: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l1.8 5.4L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.6L12 3z"/></svg>`,
    lifestyle: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s-7.5-4.6-10-9.3C.5 8 2 4 6 4c2 0 3.5 1.2 4 2 .5-.8 2-2 4-2 4 0 5.5 4 4 7.7C19.5 16.4 12 21 12 21z"/></svg>`,
  ...
  function buildSidebar() {
    ...
    const categories = [
      { id: "ai", name: "AI Apps", icon: icons.ai },
  ...
  function renderDiscover() {
    ...
    const aiApps = apps.filter((a) => a.category.includes("ai"));
